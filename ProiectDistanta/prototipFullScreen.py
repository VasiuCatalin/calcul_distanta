...
def calculate_route():
    ...
    try:
        ...
        # Adaugă traseele alternative pe hartă
...
# Obținerea dimensiunii ecranului
screen_width = root.winfo_screenwidth()
screen_height = root.winfo_screenheight()

# Setăm fereastra să fie 80% din dimensiunea ecranului
...
# Încărcarea imaginii de fundal și redimensionarea la dimensiunea ferestrei
...
label_location1 = tk.Label(frame, text="Locația 1:", bg='white', font=("Helvetica", 14))
...
label_location2 = tk.Label(frame, text="Locația 2:", bg='white', font=("Helvetica", 14))
...
button_calculate = tk.Button(frame, text="Calculează Traseul și Distanța", command=calculate_route, bg='#4CAF50', fg='white', font=('Helvetica', 14, 'bold'))
button_calculate.grid(row=2, columnspan=2, pady=10)

label_result = tk.Label(frame, text="Distanța va fi afișată aici.", bg='white', font=('Helvetica', 12))
label_result.grid(row=3, columnspan=2, pady=5)

# Buton pentru închidere
exit_button = tk.Button(frame, text="Închide", command=root.quit, bg='red', fg='white', font=('Helvetica', 12, 'bold'))
